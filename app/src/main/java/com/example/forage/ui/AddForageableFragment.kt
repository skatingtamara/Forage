...
class AddForageableFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (id > 0) {
            ...
            viewModel.getForageable(id).observe(this.viewLifecycleOwner) { selectedForageable ->
                // set the result to the forageable property . hopefully
    ...
    /*
* Creates and shows an AlertDialog if Name is missing from DB.
*/
    private fun showDataNeededDialog() {
        MaterialAlertDialogBuilder(requireContext())
            .setTitle(getString(R.string.whoops))
            .setMessage(getString(R.string.missing))
